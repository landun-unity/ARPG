...
local ArmyImmediateConscription = class("ArmyImmediateConscription", GameMessage);

--
-- 构造函数
--
function ArmyImmediateConscription:ctor()
    ArmyImmediateConscription.super.ctor(self);
    --
    -- 玩家Id
    --
    self.playerId = 0;
...
--@Override
function ArmyImmediateConscription:_OnSerial() 
...
--@Override
function ArmyImmediateConscription:_OnDeserialize() 
...
return ArmyImmediateConscription;
