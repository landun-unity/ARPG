...
local OpenLeagueMarkRespond = class("OpenLeagueMarkRespond", GameMessage);

--
-- 构造函数
--
function OpenLeagueMarkRespond:ctor()
    OpenLeagueMarkRespond.super.ctor(self);
    --
    -- 标记list
    --
    self.list = List.new();
...
--@Override
function OpenLeagueMarkRespond:_OnSerial() 
...
--@Override
function OpenLeagueMarkRespond:_OnDeserialize() 
