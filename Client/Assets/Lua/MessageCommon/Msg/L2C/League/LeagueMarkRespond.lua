...
local LeagueMarkRespond = class("LeagueMarkRespond", GameMessage);

--
-- 构造函数
--
function LeagueMarkRespond:ctor()
    LeagueMarkRespond.super.ctor(self);
    --
    -- 标记list
    --
    self.list = List.new();
...
--@Override
function LeagueMarkRespond:_OnSerial() 
...
--@Override
function LeagueMarkRespond:_OnDeserialize() 
