...
local AdvanceCardSucess = class("AdvanceCardSucess", GameMessage);
   
function AdvanceCardSucess:ctor()
    -- 玩家id
    self.iD = nil
    self._tableID = nil
    self._exp = nil
...
-- @override
function AdvanceCardSucess:_OnSerial()
...
-- @override
function AdvanceCardSucess:_OnDeserialize()
