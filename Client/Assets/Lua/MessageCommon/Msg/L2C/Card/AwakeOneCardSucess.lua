...
local AwakeOneCardSucess = class("AwakeOneCardSucess", GameMessage);
   
function AwakeOneCardSucess:ctor()
    -- 玩家id
    self.iD = nil
    self._tableID = nil
    self._exp = nil
...
-- @override
function AwakeOneCardSucess:_OnSerial()
...
-- @override
function AwakeOneCardSucess:_OnDeserialize()
