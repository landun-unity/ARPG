...
local OneCardAddPointRespond = class("OneCardAddPointRespond", GameMessage);
   
function OneCardAddPointRespond:ctor()
    -- 玩家id
    self.iD = nil
    self._tableID = nil
    self._exp = nil
...
-- @override
function OneCardAddPointRespond:_OnSerial()
...
-- @override
function OneCardAddPointRespond:_OnDeserialize()
