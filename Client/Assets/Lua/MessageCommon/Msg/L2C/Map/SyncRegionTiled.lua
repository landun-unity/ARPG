...
local SyncRegionTiled = class("SyncRegionTiled", GameMessage);

--
-- 构造函数
--
function SyncRegionTiled:ctor()
    SyncRegionTiled.super.ctor(self);
    --
    -- 所有的格子
    --
...
--@Override
function SyncRegionTiled:_OnSerial() 
...
--@Override
function SyncRegionTiled:_OnDeserialize() 
