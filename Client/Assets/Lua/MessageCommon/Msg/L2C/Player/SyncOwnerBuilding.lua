...
local SyncOwnerBuilding = class("SyncOwnerBuilding", GameMessage);

--
-- 构造函数
--
function SyncOwnerBuilding:ctor()
    SyncOwnerBuilding.super.ctor(self);
    --
    -- 建筑物列表
    --
...
--@Override
function SyncOwnerBuilding:_OnSerial() 
...
--@Override
function SyncOwnerBuilding:_OnDeserialize() 
