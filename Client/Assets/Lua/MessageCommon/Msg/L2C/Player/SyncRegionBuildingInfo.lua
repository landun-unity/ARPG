...
local SyncRegionBuildingInfo = class("SyncRegionBuildingInfo", GameMessage);

--
-- 构造函数
--
function SyncRegionBuildingInfo:ctor()
    SyncRegionBuildingInfo.super.ctor(self);
    --
    -- 建筑物列表
    --
...
--@Override
function SyncRegionBuildingInfo:_OnSerial() 
...
--@Override
function SyncRegionBuildingInfo:_OnDeserialize() 
