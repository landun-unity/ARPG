...
local SyncPlayerFortArmy = class("SyncPlayerFortArmy", GameMessage);

--
-- 构造函数
--
function SyncPlayerFortArmy:ctor()
    SyncPlayerFortArmy.super.ctor(self);
    --
    -- 单个部队
    --
...
--@Override
function SyncPlayerFortArmy:_OnSerial() 
...
--@Override
function SyncPlayerFortArmy:_OnDeserialize() 
